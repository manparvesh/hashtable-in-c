...
void SEARCH_KEY (KEY_NAME, VALUE_NAME)(KEY_TYPE *array, KEY_TYPE key) {

}

void INSERT (KEY_NAME, VALUE_NAME)(KEY_TYPE *array, KEY_TYPE key, VALUE_TYPE value) {

}

void DELETE_KEY (KEY_NAME, VALUE_NAME)(KEY_TYPE *array, KEY_TYPE key) {
